...
function my_user_vote2() {
		...
		$body .= "Почта: " . $email . "<br><br>";

		$body .= "Товар: " . $products_name . "<br>";
		...
		$mail->SetFrom('webmaster@win03.beget.tech', 'Заявка');
        ...
        // $mail->AddAttachment($path_pdf, '', $encoding = 'base64', $type = 'application/pdf');
        global $message;
        if(!$mail->Send()) {
