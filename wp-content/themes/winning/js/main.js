...
$(function () {
  ...
  $('.js-slider-main-1').slick({
    ...
    arrows: true,
    fade: true,
    prevArrow: '<div class="slider__arrow slider__arrow_prev"><img class="slider__arrow-img" src="http://winning.beget.tech/wp-content/themes/winning/images/icon/arrow-prev-2.svg"></div>',
    nextArrow: '<div class="slider__arrow slider__arrow_next"><img class="slider__arrow-img" src="http://winning.beget.tech/wp-content/themes/winning/images/icon/arrow-prev-2.svg"></div>',
